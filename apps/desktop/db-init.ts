...
import { FRESH_SCHEMA_SQL } from './db-fresh-schema.generated';
...
function createFreshSchema(db: Database.Database): void {
  // SQL is auto-generated from prisma/schema.prisma. Regenerate via
  // `npm run db:generate-fresh-schema` after any schema change.
