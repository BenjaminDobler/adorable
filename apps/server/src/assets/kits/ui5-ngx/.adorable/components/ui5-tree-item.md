...
**Import:** `import { TreeItemComponent } from '@ui5/webcomponents-ngx/main/tree-item';`
**Export As:** `ui5TreeItem`
**Package:** `@ui5/webcomponents` (main)

## Basic Usage
```html
<ui5-tree-item [type]="..." (ui5DetailClick)="onDetailClick($event)"></ui5-tree-item>
```

## Description
The ui5-tree-item represents a node in a tree structure, shown as a ui5-list. This is the item to use inside a ui5-tree. You can represent an arbitrary tree structure by recursively nesting tree items. import "@ui5/webcomponents/dist/TreeItem.js";
...
| `additionalText` | `string | undefined` | `undefined` | Defines the additionalText, displayed in the end of the tree item. |
