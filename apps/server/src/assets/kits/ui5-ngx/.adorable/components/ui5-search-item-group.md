...
**Import:** `import { SearchItemGroupComponent } from '@ui5/webcomponents-ngx/fiori/search-item-group';`
**Export As:** `ui5SearchItemGroup`
**Package:** `@ui5/webcomponents-fiori` (fiori)

## Basic Usage
```html
<ui5-search-item-group [headerText]="..." (ui5MoveOver)="onMoveOver($event)"></ui5-search-item-group>
```
