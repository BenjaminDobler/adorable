...
**Selector:** `<ui5-notification-group-list>`
...
## Description
Internal ui5-li-notification-group-list component, that is used to support keyboard navigation of the notification group internal list.
