...
**Import:** `import { SuggestionItemGroupComponent } from '@ui5/webcomponents-ngx/main/suggestion-item-group';`
**Export As:** `ui5SuggestionItemGroup`
**Package:** `@ui5/webcomponents` (main)

## Basic Usage
```html
<ui5-suggestion-item-group [headerText]="..." (ui5MoveOver)="onMoveOver($event)"></ui5-suggestion-item-group>
```
