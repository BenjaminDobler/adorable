...
**Import:** `import { ComboBoxItemGroupComponent } from '@ui5/webcomponents-ngx/main/combo-box-item-group';`
**Export As:** `ui5CbItemGroup`
**Package:** `@ui5/webcomponents` (main)

## Basic Usage
```html
<ui5-cb-item-group [headerText]="..." (ui5MoveOver)="onMoveOver($event)"></ui5-cb-item-group>
```
