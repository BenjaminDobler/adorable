...
**Import:** `import { PopoverComponent } from '@ui5/webcomponents-ngx/main/popover';`
**Export As:** `ui5Popover`
**Package:** `@ui5/webcomponents` (main)

## Basic Usage
```html
<ui5-popover [initialFocus]="..." (ui5BeforeOpen)="onBeforeOpen($event)"></ui5-popover>
```

## Description
The ui5-popover component displays additional information for an object in a compact way and without leaving the page. The Popover can contain various UI elements, such as fields, tables, images, and charts. It can also include actions in the footer. The popover has three main areas: - Header (optional) - Content - Footer (optional) **Note:** The ui5-popover is closed when the user clicks or taps outside the popover or selects an action within the popover. You can prevent this with the modal property. import "@ui5/webcomponents/dist/Popover.js";
