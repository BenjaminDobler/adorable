...
+"- You **MUST** read the code of any file you plan to modify. Use `read_files` (plural) to read multiple files at once — this is much faster than individual `read_file` calls.\n"
